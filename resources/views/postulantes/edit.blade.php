        ...
        <div class="col-12 col-lg-11 col-xl-10">
            ...
            <div class="card border-0 shadow-lg mb-4 overflow-hidden rounded-4">
                <div class="card-header text-white py-4 position-relative"
                    style="background: linear-gradient(135deg, #f1c40f 0%, #f39c12 100%);">

                    <div class="d-flex align-items-center justify-content-left">
                        <i class="bi bi-pencil-square me-3 fs-2 text-white"></i>
                        <div>
                            <h4 class="m-0 fw-bold text-uppercase">Editar Postulante</h4>
                            <small class="text-white-50 fst-italic">Modifique los datos del postulante: {{ $postulante->apellidos_nombres }}</small>
                        </div>
                    </div>
            ...
            <form action="{{ route('postulantes.update', $postulante->id) }}" method="POST" enctype="multipart/form-data" id="formEditPostulante" novalidate>
                @csrf
                @method('PUT')
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="apellidos_nombres" id="apellidos_nombres" class="form-control @error('apellidos_nombres') is-invalid @enderror" placeholder="Apellidos y Nombres" value="{{ old('apellidos_nombres', $postulante->apellidos_nombres) }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <input type="text" name="dni" id="dni" class="form-control @error('dni') is-invalid @enderror" placeholder="DNI" value="{{ old('dni', $postulante->dni) }}" maxlength="8" pattern="[0-9]{8}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" value="{{ old('fecha_nacimiento', $postulante->fecha_nacimiento ? $postulante->fecha_nacimiento->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <select name="sexo" id="sexo" class="form-select @error('sexo') is-invalid @enderror">
                                                ...
                                                <option value="No especifica" {{ old('sexo', $postulante->sexo) == 'No especifica' ? 'selected' : '' }}>No especifica</option>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <select name="estado_civil" id="estado_civil" class="form-select @error('estado_civil') is-invalid @enderror">
                                                ...
                                                <option value="Conviviente" {{ old('estado_civil', $postulante->estado_civil) == 'Conviviente' ? 'selected' : '' }}>Conviviente</option>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <input type="number" name="numero_hijos" id="numero_hijos" class="form-control @error('numero_hijos') is-invalid @enderror" placeholder="0" value="{{ old('numero_hijos', $postulante->numero_hijos) }}" min="0">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <input type="text" name="ciudad_postular" id="ciudad_postular" class="form-control" placeholder="Ciudad" value="{{ old('ciudad_postular', $postulante->ciudad_postular) }}">
                                            <label for="ciudad_postular">Ciudad a Postular</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <select name="estado" id="estado" class="form-select @error('estado') is-invalid @enderror">
                                                <option value="">-- Seleccionar --</option>
                                                <option value="nuevo" {{ old('estado', $postulante->estado) == 'nuevo' ? 'selected' : '' }}>Nuevo</option>
                                                <option value="en evaluación" {{ old('estado', $postulante->estado) == 'en evaluación' ? 'selected' : '' }}>En evaluación</option>
                                                <option value="aceptado" {{ old('estado', $postulante->estado) == 'aceptado' ? 'selected' : '' }}>Aceptado</option>
                                                <option value="rechazado" {{ old('estado', $postulante->estado) == 'rechazado' ? 'selected' : '' }}>Rechazado</option>
                                                <option value="re-postulación" {{ old('estado', $postulante->estado) == 're-postulación' ? 'selected' : '' }}>Re-postulación</option>
                                            </select>
                        ...
                        <div id="collapseContacto" class="accordion-collapse collapse show" aria-labelledby="headingContacto" data-bs-parent="#formularioPostulanteAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="correo@ejemplo.com" value="{{ old('email', $postulante->email) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="tel" name="telefono" id="telefono" class="form-control @error('telefono') is-invalid @enderror" 
                                                placeholder="Teléfono" value="{{ old('telefono', $postulante->telefono) }}" maxlength="9" pattern="\d{9}" title="Ingrese 9 dígitos numéricos">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <select name="operador" id="operador" class="form-select">
                                                ...
                                                <option value="Movistar" {{ old('operador', $postulante->operador) == 'Movistar' ? 'selected' : '' }}>Movistar</option>
                                                <option value="Claro" {{ old('operador', $postulante->operador) == 'Claro' ? 'selected' : '' }}>Claro</option>
                                                <option value="Entel" {{ old('operador', $postulante->operador) == 'Entel' ? 'selected' : '' }}>Entel</option>
                                                <option value="Bitel" {{ old('operador', $postulante->operador) == 'Bitel' ? 'selected' : '' }}>Bitel</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="distrito" id="distrito" class="form-control" placeholder="Distrito" value="{{ old('distrito', $postulante->distrito) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="provincia" id="provincia" class="form-control" placeholder="Provincia" value="{{ old('provincia', $postulante->provincia) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="departamento" id="departamento" class="form-control" placeholder="Departamento" value="{{ old('departamento', $postulante->departamento) }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="text" name="direccion" id="direccion" class="form-control @error('direccion') is-invalid @enderror" placeholder="Dirección completa" value="{{ old('direccion', $postulante->direccion) }}">
                        ...
                        <div id="collapseSalud" class="accordion-collapse collapse" aria-labelledby="headingSalud" data-bs-parent="#formularioPostulanteAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="number" step="0.01" name="estatura" id="estatura" class="form-control @error('estatura') is-invalid @enderror" placeholder="Ej: 1.75" value="{{ old('estatura', $postulante->estatura) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="number" step="0.1" name="peso" id="peso" class="form-control @error('peso') is-invalid @enderror" placeholder="Ej: 70.5" value="{{ old('peso', $postulante->peso) }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" name="imc" id="imc" class="form-control" placeholder="Calculado" readonly tabindex="-1" value="{{ old('imc', $postulante->imc) }}">
                                    ...
                                    <div class="col-md-4 d-flex align-items-center">
                                        ...
                                        <div class="form-check form-switch mb-0">
                                            <input type="hidden" name="vacunado" value="0">
                                            <input 
                                                ...
                                                id="vacunado_si" 
                                                value="1"
                                                @if(old('vacunado', $postulante->vacunado)) checked @endif
                                    ...
                                    <div class="col-md-4" id="campo_numero_vacunas" style="{{ old('vacunado', $postulante->vacunado) ? '' : 'display:none;' }}">
                                        <div class="form-floating">
                                            <input 
                                                type="number" 
                                                name="numero_vacunas" 
                                                ...
                                                value="{{ old('numero_vacunas', $postulante->numero_vacunas) }}">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="antecedentes_penales" value="0">
                                            <input class="form-check-input" type="checkbox" name="antecedentes_penales" value="1" id="antecedentes_penales" @if(old('antecedentes_penales', $postulante->antecedentes_penales)) checked @endif>
                                            <label class="form-check-label" for="antecedentes_penales">Antecedentes Penales</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="certificado_estudios" value="0">
                                            <input class="form-check-input" type="checkbox" name="certificado_estudios" value="1" id="certificado_estudios" @if(old('certificado_estudios', $postulante->certificado_estudios)) checked @endif>
                                            <label class="form-check-label" for="certificado_estudios">Certificado de Estudios</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="certiadulto" value="0">
                                            <input class="form-check-input" type="checkbox" name="certiadulto" value="1" id="certiadulto" @if(old('certiadulto', $postulante->certiadulto)) checked @endif>
                                            <label class="form-check-label" for="certiadulto">Certiadulto</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="recibo_agua" value="0">
                                            <input class="form-check-input" type="checkbox" name="recibo_agua" value="1" id="recibo_agua" @if(old('recibo_agua', $postulante->recibo_agua)) checked @endif>
                                            <label class="form-check-label" for="recibo_agua">Recibo de Luz o Agua</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="multa_electoral" value="0">
                                            <input class="form-check-input" type="checkbox" name="multa_electoral" value="1" id="multa_electoral" @if(old('multa_electoral', $postulante->multa_electoral)) checked @endif>
                                            ...
                                            @foreach([
                                                ...
                                                <div class="col-md-4">
                                                    <div class="p-3 bg-white rounded-3 shadow-sm border hover-lift">
                                                        ...
                                                        @if($postulante->$inputName)
                                                            <div class="mt-2">
                                                                <small class="text-muted fst-italic">Archivo actual:</small>
                                                                <a href="{{ asset('storage/' . $postulante->$inputName) }}" target="_blank" class="d-block text-truncate">
                                                                    <small class="text-primary">{{ basename($postulante->$inputName) }}</small>
                                                                </a>
                                                            </div>
                                                        @else
                        ...
                        <div id="collapseVehiculo" class="accordion-collapse collapse" aria-labelledby="headingVehiculo" data-bs-parent="#formularioPostulanteAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col-md-2">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="tiene_vehiculo" value="0">
                                            <input class="form-check-input" type="checkbox" name="tiene_vehiculo" id="vehiculo_si" value="1" 
                                                @if(old('tiene_vehiculo', $postulante->tiene_vehiculo)) checked @endif>
                                    ...
                                    <div class="col-md-3" id="campo_tipo_vehiculo">
                                        <div class="form-floating">
                                            <input type="text" name="tipo_vehiculo" id="tipo_vehiculo" 
                                                ...
                                                placeholder="Ej: Auto, Moto" value="{{ old('tipo_vehiculo', $postulante->tipo_vehiculo) }}" @if(!old('tiene_vehiculo', $postulante->tiene_vehiculo)) disabled @endif>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <input type="text" name="placa" id="placa" class="form-control" placeholder="Placa" value="{{ old('placa', $postulante->placa) }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <input type="text" name="tipo_licencia" id="tipo_licencia" class="form-control" placeholder="Ej: A1, B" value="{{ old('tipo_licencia', $postulante->tipo_licencia) }}">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="tiene_soat" value="0">
                                            <input class="form-check-input" type="checkbox" name="tiene_soat" id="soat_si" value="1" @if(old('tiene_soat', $postulante->tiene_soat)) checked @endif>
                                    ...
                                    <div class="col-md-3" id="campo_numero_soat">
                                        <div class="form-floating">
                                            <input type="text" name="numero_soat" id="numero_soat" class="form-control @error('numero_soat') is-invalid @enderror" placeholder="Número" value="{{ old('numero_soat', $postulante->numero_soat) }}" @if(!old('tiene_soat', $postulante->tiene_soat)) disabled @endif>
                        ...
                        <div id="collapseSucamec" class="accordion-collapse collapse" aria-labelledby="headingSucamec" data-bs-parent="#formularioPostulanteAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="tiene_licencia_l1" value="0">
                                            <input class="form-check-input" type="checkbox" name="tiene_licencia_l1" id="l1_si" value="1" @if(old('tiene_licencia_l1', $postulante->tiene_licencia_l1)) checked @endif>
                                            <label class="form-check-label" for="l1_si">Licencia L1</label>
                                        </div>
                                        <div class="mt-2 fade-in" id="campo_vigencia_l1" style="{{ old('tiene_licencia_l1', $postulante->tiene_licencia_l1) ? '' : 'display:none;' }}">
                                            <input type="date" name="vigencia_licencia_l1" id="vigencia_licencia_l1" class="form-control" value="{{ old('vigencia_licencia_l1', $postulante->vigencia_licencia_l1 ? $postulante->vigencia_licencia_l1->format('Y-m-d') : '') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="tiene_licencia_l4" value="0">
                                            <input class="form-check-input" type="checkbox" name="tiene_licencia_l4" id="l4_si" value="1" @if(old('tiene_licencia_l4', $postulante->tiene_licencia_l4)) checked @endif>
                                            <label class="form-check-label" for="l4_si">Licencia L4</label>
                                        </div>
                                        <div class="mt-2 fade-in" id="campo_vigencia_l4" style="{{ old('tiene_licencia_l4', $postulante->tiene_licencia_l4) ? '' : 'display:none;' }}">
                                            <input type="date" name="vigencia_licencia_l4" id="vigencia_licencia_l4" class="form-control" value="{{ old('vigencia_licencia_l4', $postulante->vigencia_licencia_l4 ? $postulante->vigencia_licencia_l4->format('Y-m-d') : '') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-switch">
                                            <input type="hidden" name="tiene_licencia_l5" value="0">
                                            <input class="form-check-input" type="checkbox" name="tiene_licencia_l5" id="l5_si" value="1" @if(old('tiene_licencia_l5', $postulante->tiene_licencia_l5)) checked @endif>
                                            <label class="form-check-label" for="l5_si">Licencia L5</label>
                                        </div>
                                        <div class="mt-2 fade-in" id="campo_vigencia_l5" style="{{ old('tiene_licencia_l5', $postulante->tiene_licencia_l5) ? '' : 'display:none;' }}">
                                            <input type="date" name="vigencia_licencia_l5" id="vigencia_licencia_l5" class="form-control" value="{{ old('vigencia_licencia_l5', $postulante->vigencia_licencia_l5 ? $postulante->vigencia_licencia_l5->format('Y-m-d') : '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="collapseTallas" class="accordion-collapse collapse" aria-labelledby="headingTallas" data-bs-parent="#formularioPostulanteAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col-md-2">
                                        <div class="form-floating">
                                            <input type="text" name="talla_pantalon" id="talla_pantalon" class="form-control" placeholder="Pantalón" value="{{ old('talla_pantalon', $postulante->talla_pantalon) }}">
                                            <label for="talla_pantalon">Pantalón</label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-floating">
                                            <input type="text" name="talla_casaca" id="talla_casaca" class="form-control" placeholder="Casaca" value="{{ old('talla_casaca', $postulante->talla_casaca) }}">
                                            <label for="talla_casaca">Casaca</label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-floating">
                                            <input type="text" name="talla_polo" id="talla_polo" class="form-control" placeholder="Polo" value="{{ old('talla_polo', $postulante->talla_polo) }}">
                                            <label for="talla_polo">Polo</label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-floating">
                                            <input type="text" name="talla_camisa" id="talla_camisa" class="form-control" placeholder="Camisa" value="{{ old('talla_camisa', $postulante->talla_camisa) }}">
                                            <label for="talla_camisa">Camisa</label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-floating">
                                            <input type="text" name="talla_zapato" id="talla_zapato" class="form-control" placeholder="Zapato" value="{{ old('talla_zapato', $postulante->talla_zapato) }}">
                        ...
                        <div id="collapseBancarios" class="accordion-collapse collapse" aria-labelledby="headingBancarios" data-bs-parent="#formularioPostulanteAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="cuenta_bancaria" id="cuenta_bancaria" class="form-control" placeholder="Cuenta Bancaria" value="{{ old('cuenta_bancaria', $postulante->cuenta_bancaria) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select name="banco" id="banco" class="form-select">
                                                ...
                                                <option value="BCP" {{ old('banco', $postulante->banco) == 'BCP' ? 'selected' : '' }}>BCP</option>
                                                <option value="BBVA" {{ old('banco', $postulante->banco) == 'BBVA' ? 'selected' : '' }}>BBVA</option>
                                                <option value="Interbank" {{ old('banco', $postulante->banco) == 'Interbank' ? 'selected' : '' }}>Interbank</option>
                                                <option value="Scotiabank" {{ old('banco', $postulante->banco) == 'Scotiabank' ? 'selected' : '' }}>Scotiabank</option>
                                                <option value="MiBanco" {{ old('banco', $postulante->banco) == 'MiBanco' ? 'selected' : '' }}>MiBanco</option>
                                                <option value="banco de la nacion" {{ old('banco', $postulante->banco) == 'banco de la nacion' ? 'selected' : '' }}>Banco de la Nación</option>
                                            </select>
                        ...
                        <div id="collapseOtros" class="accordion-collapse collapse" aria-labelledby="headingOtros" data-bs-parent="#formularioPostulanteAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea name="detalle_experiencia" id="detalle_experiencia" rows="3" class="form-control" placeholder="Detalle de su experiencia..." style="height:140px;">{{ old('detalle_experiencia', $postulante->detalle_experiencia) }}</textarea>
                                            <label for="detalle_experiencia">Detalle de Experiencia</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="curso" id="curso" class="form-control" placeholder="Curso" value="{{ old('curso', $postulante->curso) }}">
                                            <label for="curso">Curso</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="carnet" id="carnet" class="form-control" placeholder="Carnet" value="{{ old('carnet', $postulante->carnet) }}">
                ...
                <div class="card shadow-sm border-0 mt-4">
                    <div class="card-body d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-check-circle me-2"></i>Actualizar Postulante</button>
                    </div>
                </div>
            </form>
        </div>
